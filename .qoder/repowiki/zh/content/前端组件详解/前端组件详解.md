...
脚本管理组件提供了完整的 JMeter 脚本生命周期管理功能。
...
**章节来源**
- [ScriptList.vue:1-800](file://web/src/views/ScriptList.vue#L1-L800)
- [ScriptEdit.vue:1-800](file://web/src/views/ScriptEdit.vue#L1-L800)

### 执行管理组件详解

执行管理组件提供了全面的测试执行监控和管理功能。
...
**章节来源**
- [SlaveManage.vue:1-800](file://web/src/views/SlaveManage.vue#L1-L800)
